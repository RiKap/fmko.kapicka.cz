class Fm2018
{
	...
	recountAttr()
	{
		...
		$('.result .strength .star').text(this.getStarAmount(fitness*9+total_fitness*2));
		$('.result .aerobic .star').text(this.getStarAmount(fitness*9+total_fitness*2));
		$('.result .tactics .star').text(this.getStarAmount(tactical*6+mental*3+total_fitness*2));
		$('.result .ball-control .star').text(this.getStarAmount(technical*6+mental*3+total_fitness*2));
		$('.result .defending .star').text(this.getStarAmount(defending*6+tactical*3+total_fitness*2));
		$('.result .attacking .star').text(this.getStarAmount(attacking*6+tactical*3+total_fitness*2));
		$('.result .shooting .star').text(this.getStarAmount(technical*6+attacking*3+total_fitness*2));
		$('.result .gk-distribution .star').text(this.getStarAmount(gk_distribution*9+total_fitness*2));
		$('.result .gk-handling .star').text(this.getStarAmount(gk_handling*9+total_fitness*2));
		$('.result .gk-shot-stopping .star').text(this.getStarAmount(gk_shot_stopping*9+total_fitness*2));
	}
